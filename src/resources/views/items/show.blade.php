    ...
    <div class="item-detail">
        ...
        <div class="item-detail__content">
            ...
            <div class="item-detail__button">
                ...
                @else
                    <a href="{{ route('purchase.create', $item) }}" class="item-detail__button-submit">
                        購入手続きへ
                    </a>
                @endif
            </div>
                    ...
                    <div class="item-detail__comment">
                        <div class="item-detail__comment-user">
                            @if ($comment->user->image)
                                <img class="item-detail__user-image" src="{{ asset('storage/' . $comment->user->image) }}" alt="プロフィール画像">
                            @else
            ...
            <div class="item-detail__form">
                ...
                <form class="item-detail__comment-form" action="{{ route('comments.store', $item) }}" method="post">
                    @csrf
